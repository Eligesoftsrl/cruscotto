...
stato iniziale (repository del Prototipo iniziale) allo stato attuale di lavorazione, con
...
| Aspetto | Prima (Prototipo) | Stato attuale (in lavorazione) |
|--------|------------------|--------------------|
...
> professionale e manutenibile** — il percorso in corso da "Prototipo che
