    ...
    <div className="bg-card border rounded-lg flex flex-col col-span-6">
      <div className="px-4 py-3 border-b">
        <div className="text-[13px] font-semibold text-foreground">
          Analisi per genere e fascia d'età
        </div>
        <div className="text-[10.5px] text-muted-foreground/60 mt-0.5">
          Anno 2023 · quota donne per fascia
        </div>
      </div>
                  ...
                  {r.delta === "–" ? (
                    ...
                    <span
                      className={`inline-block px-1.5 py-0.5 rounded text-[10px] font-semibold ${
                        r.deltaType === "up" ? "bg-red-50 text-destructive" : "bg-green-50"
                      }`}
                      style={
                        r.deltaType === "down" ? { color: "hsl(var(--chart-green))" } : undefined
                      }
                    >
                      {r.delta}
                    </span>
