...
export const CessazioniSection = () => {
  ...
  const { cessazioniPerCausale, serieStoricaCessati, kpiOverview, isLoading, error } =
    useCessatiData(2023);
    ...
    <div className="space-y-4">
      ...
      <KpiGrid>
        {[
          {
            label: "Cessati 2023",
            value: totaleCessati.toLocaleString("it-IT"),
            icon: LogOut,
          ...
          {
            label: "Saldo netto",
            value: (saldo >= 0 ? "+" : "") + saldo.toLocaleString("it-IT"),
            icon: ArrowRightLeft,
            color: saldo >= 0 ? "hsl(var(--chart-teal))" : "hsl(var(--chart-red))",
          },
          {
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={cessazioni} layout="vertical" margin={{ left: 10 }}>
              ...
              {(showBoth || genere === "Uomini") && (
                <Bar dataKey="uomini" name="Uomini" fill="hsl(var(--chart-blue))" stackId="a" />
              )}
