...
export const metodologie: Record<string, MetodologiaEntry> = {
  ...
  ICVC: {
    ...
    calcolo: "ICVC = Risorse valutate nel periodo / Totale risorse in organico\n\nDominio: [0; 1]",
    interpretazione:
      "Valori elevati indicano maggiore diffusione dei processi di valutazione delle competenze.",
    note: "Misurato rispetto ad arco temporale definito (es. ultimi 3 anni).",
  },
  ...
  IACU: {
    ...
    note: "L'analisi non si concentra sulla costruzione di un singolo valore medio, ma sull'osservazione della distribuzione dei livelli di copertura nel personale. A livello di singola amministrazione può essere analizzato per singolo profilo di ruolo.",
  },

  "IIMP/R_sub": {
    // alias - the main entry is already under "IIMP/R"
  ...
  IGF: {
    ...
    note: "L'IGF è un indicatore composito che aggrega quattro sotto-indicatori sintetici. Il suo valore deve essere letto congiuntamente ai valori delle singole componenti per comprendere quali dimensioni trainano o frenano il punteggio complessivo.",
  },

  IRS: {
    definizione:
      "Misura il rapporto tra personale effettivamente in servizio e dotazione organica prevista. Consente di valutare il livello di copertura delle posizioni.",
    calcolo: "IRS = Personale in servizio / Dotazione organica\n\nDominio: [0; 1]",
    interpretazione:
      "• IRS → 1: Piena copertura della dotazione organica\n• IRS ≈ 0,7: Scopertura significativa\n• IRS → 0: Forte sottorganico",
    note: "Fonte: Conto Annuale.",
  },

  IDP_Norm: {
    definizione:
      "Misura la direzione della progressività occupazionale, ovvero se il saldo netto tra assunti e cessati è positivo (espansione) o negativo (contrazione).",
    calcolo: "IDP = (Assunti − Cessati) / Cessati\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• IDP > 0,5: Saldo netto positivo (crescita)\n• IDP = 0,5: Equilibrio tra entrate e uscite\n• IDP < 0,5: Saldo netto negativo (contrazione)",
    note: "Fonte: Conto Annuale.",
  },

  PTI: {
    definizione:
      "Misura la quota di assunzioni effettuate con contratto a tempo indeterminato sul totale delle assunzioni. Consente di valutare la stabilità contrattuale del reclutamento.",
    calcolo: "PTI = Assunti a tempo indeterminato / Totale assunti\n\nDominio: [0; 1]",
    interpretazione:
      "• PTI elevato → reclutamento orientato alla stabilizzazione\n• PTI medio → mix contrattuale equilibrato\n• PTI basso → prevalenza di forme flessibili",
    note: "Fonte: Conto Annuale.",
  },

  IRG_Norm: {
    definizione:
      "Misura il rapporto tra nuove assunzioni di giovani (under 35) e cessazioni di personale prossimo al pensionamento (over 60). Consente di valutare l'adeguatezza del ricambio generazionale.",
    calcolo: "IRG = Assunti under 35 / Cessati over 60\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• IRG → 1: Pieno ricambio generazionale\n• IRG ≈ 0,5: Ricambio parziale\n• IRG → 0: Insufficiente ricambio; rischio invecchiamento",
    note: "Fonte: Conto Annuale.",
  },
  ...
  IAR: {
    ...
    note: "Fonte: InPA e Conto Annuale. L'indice IAR svolge una funzione di collegamento tra il Pillar D2 (programmazione del fabbisogno) e il Pillar D3 (recruiting).",
  },
  ...
  DDP: {
    ...
    calcolo: "DDP_profilo = Posti banditi per profilo / Totale posti banditi\n\nDominio: [0; 1]",
    interpretazione:
    ...
    note: "Fonte: Lavoro Pubblico. L'indicatore è particolarmente significativo a livello aggregato (cluster di amministrazioni o sistema PA) e su orizzonti temporali pluriennali (almeno 3 anni).",
  },
  ...
  IAP: {
    ...
    calcolo: "IAP = Candidature ricevute / Posizioni ricercate\n\nDominio: [0; +∞)",
    interpretazione:
    ...
    note: "Fonte: InPA. L'indicatore può essere analizzato per tipologia di selezione, titolo di studio richiesto, fascia salariale della posizione, e consente di analizzare le candidature per genere e fasce di età.",
  },
  ...
  IAT: {
    ...
    note: "Fonte: InPA. Può essere analizzato per tipologia di selezione, titolo di studio richiesto, fascia salariale e per genere/fasce di età.",
  },
  ...
  TSC: {
    ...
    calcolo: "TSC = Numero idonei / Numero candidati\n\nDominio: [0; +∞)",
    interpretazione:
    ...
    note: "Fonte: Applicazione Graduatorie Portale Lavoro Pubblico. Analizzato su cluster omogenei, può segnalare ambiti professionali nei quali il reclutamento risulta più complesso.",
  },
  ...
  TCP: {
    ...
    note: "Fonte: Applicazione Graduatorie Portale Lavoro Pubblico. Consente di valutare l'efficienza amministrativa delle procedure di reclutamento.",
  },

  TCPB: {
    definizione:
      "Misura la capacità delle procedure concorsuali di coprire i posti messi a bando attraverso l'assunzione dei vincitori.",
    calcolo: "TCPB = Numero vincitori assunti / Numero posti banditi\n\nDominio: [0; 1]",
    interpretazione:
    ...
    note: "Fonte: Applicazione Graduatorie Portale Lavoro Pubblico.",
  },
  ...
  CGC: {
    definizione:
      "Misura il grado con cui l'Ente governa le competenze come oggetto esplicito di progettazione organizzativa, integrando estensione e intensità della formazione, attivazione delle dinamiche di crescita interna e coerenza tra capitale umano posseduto e struttura delle qualifiche.",
    calcolo: "CGC = (TCF + IFM_Norm + DPI_Norm + CQT) / 4\n\nDominio: [0; 1]",
    interpretazione:
      "• CGC → 0: Debole capacità di governo delle competenze.\n• CGC ≈ 0,5: Gestione parzialmente strutturata.\n• CGC → 1: Elevata capacità di gestione delle competenze.",
    note: "Fonte: Conto Annuale.",
  },

  TCF: {
    definizione:
      "Misura la quota di personale che ha partecipato ad attività formative nel periodo di riferimento sul totale dell'organico.",
    calcolo: "TCF = Personale formato / Personale totale\n\nDominio: [0; 1]",
    interpretazione:
      "• TCF elevato → formazione diffusa\n• TCF medio → copertura parziale\n• TCF basso → formazione limitata a specifici segmenti",
    note: "Fonte: Conto Annuale.",
  },

  IFM_Norm: {
    definizione:
      "Misura l'intensità media della formazione erogata, calcolata come giornate medie di formazione per dipendente formato, rapportata al target normativo.",
    calcolo:
      "IFM = Giornate formazione medie per dipendente / Target giornate (6 gg/anno)\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• IFM → 1: Investimento formativo in linea con il target\n• IFM ≈ 0,5: Investimento inferiore al target\n• IFM → 0: Formazione marginale",
    note: "Fonte: Conto Annuale. Il target di 6 giornate è quello previsto dalla normativa.",
  },

  DPI_Norm: {
    definizione:
      "Misura l'intensità delle progressioni verticali rispetto alla dimensione dell'organico. Indica la dinamicità del sistema di carriera interna.",
    calcolo: "DPI = Progressioni verticali / Personale totale\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• DPI elevato → alta mobilità interna\n• DPI moderato → dinamicità nella norma\n• DPI basso → struttura statica",
    note: "Fonte: Conto Annuale. Utilizzato sia in D4 (sviluppo) sia in D5 (carriera).",
  },

  CQT: {
    definizione:
      "Misura la coerenza tra il titolo di studio posseduto dal personale e la qualifica ricoperta. Consente di valutare l'allineamento tra capitale umano formale e struttura delle posizioni.",
    calcolo:
      "CQT = Personale con titolo coerente alla qualifica / Personale totale\n\nDominio: [0; 1]",
    interpretazione:
      "• CQT → 1: Piena coerenza tra titoli e qualifiche\n• CQT ≈ 0,5: Coerenza parziale\n• CQT → 0: Forte mismatch tra titoli e posizioni",
    note: "Fonte: Conto Annuale. Non misura la qualità delle competenze ma l'allineamento formale.",
  },

  ISTP_Norm: {
    definizione:
      "Misura la quota di dipendenti che hanno un percorso di specializzazione tecnico-professionale attivo sul totale dei dipendenti con profilo assegnato.",
    calcolo:
      "ISTP = Dipendenti con percorso specialistico / Dipendenti con profilo\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• ISTP elevato → forte investimento in specializzazione\n• ISTP moderato → specializzazione in corso\n• ISTP basso → specializzazione limitata",
    note: "Fonte: Sistema Minerva.",
  },

  IDFP: {
    definizione:
      "Misura la varietà delle famiglie professionali attive nell'amministrazione rispetto al catalogo nazionale. Indica il grado di diversificazione delle professionalità.",
    calcolo: "IDFP = Famiglie professionali attive / Famiglie catalogo DFP\n\nDominio: [0; 1]",
    interpretazione:
      "• IDFP → 1: Piena copertura del catalogo professionale\n• IDFP ≈ 0,5: Copertura parziale\n• IDFP → 0: Limitata diversificazione",
    note: "Fonte: Sistema Minerva.",
  },

  ICRP: {
    definizione:
      "Misura la quota di ruoli professionali definiti nel sistema che risultano effettivamente coperti da almeno un dipendente.",
    calcolo: "ICRP = Ruoli con almeno 1 dipendente / Ruoli definiti totali\n\nDominio: [0; 1]",
    interpretazione:
      "• ICRP → 1: Tutti i ruoli definiti sono operativamente coperti\n• ICRP ≈ 0,5: Metà dei ruoli sono vuoti\n• ICRP → 0: Forte disconnessione tra modello e realtà",
    note: "Fonte: Sistema Minerva.",
  },

  IEF_Norm: {
    definizione:
      "Misura l'efficacia della formazione in termini di completamento con successo dei percorsi formativi avviati.",
    calcolo: "IEF = Corsi completati con successo / Corsi iniziati\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• IEF elevato → alta efficacia formativa\n• IEF moderato → efficacia parziale\n• IEF basso → alto tasso di abbandono",
    note: "Fonte: Syllabus.",
  },

  ICQ: {
    definizione:
      "Misura la quota di completamenti formativi che hanno portato a un riconoscimento formale (badge, certificazione, qualificazione).",
    calcolo: "ICQ = Completamenti con qualificazione / Completamenti totali\n\nDominio: [0; 1]",
    interpretazione:
      "• ICQ elevato → formazione qualificante diffusa\n• ICQ moderato → qualificazione parziale\n• ICQ basso → formazione prevalentemente non qualificante",
    note: "Fonte: Syllabus.",
  },

  ICEC: {
    definizione:
      "Misura la coerenza evolutiva delle competenze: il grado in cui i percorsi formativi producono un effettivo avanzamento nel colmare i gap di competenze.",
    calcolo: "ICEC = Δ competenze post-formazione / Gap iniziale\n\nDominio: [0; 1]",
    interpretazione:
      "• ICEC → 1: Formazione altamente efficace nel colmare i gap\n• ICEC ≈ 0,5: Efficacia parziale\n• ICEC → 0: Formazione non produce miglioramenti significativi",
    note: "Fonte: Syllabus.",
  },

  ISCP: {
    definizione:
      "Sintetizza il livello complessivo di sviluppo e articolazione del capitale professionale dell'Amministrazione.",
    calcolo: "ISCP = (ISTP_Norm + IDFP + ICRP) / 3\n\nDominio: [0; 1]",
    interpretazione:
      "• ISCP → 1: Massima copertura delle dimensioni professionali.\n• ISCP ≈ 0,5: Livello intermedio.\n• ISCP → 0: Nessuna strutturazione professionale.",
    note: "Fonte: Sistema Minerva.",
  },

  IESF: {
    definizione:
      "Sintetizza il grado con cui i percorsi formativi producono un effettivo sviluppo delle competenze del personale.",
    calcolo: "IESF = (IEF_Norm + ICQ + ICEC) / 3\n\nDominio: [0; 1]",
    interpretazione:
      "• IESF → 1: Elevata efficacia formativa.\n• IESF ≈ 0,5: Efficacia parziale.\n• IESF → 0: Formazione non efficace.",
    note: "Fonte: Syllabus.",
  },

  ICS_Norm: {
    definizione:
      "Misura la variazione relativa della retribuzione media nel tempo, indicando se nel tempo aumenta la quota di personale collocato nelle categorie superiori.",
    calcolo: "ICS = Δ retribuzione media / Retribuzione media\n\nNormalizzato in [0; 1]",
    interpretazione:
      "• ICS elevato → crescita strutturale significativa\n• ICS moderato → crescita contenuta\n• ICS basso → struttura retributiva statica",
    note: "Fonte: Conto Annuale.",
  },
  ...
  IDC: {
    ...
    note: "Fonte: Conto Annuale. L'indicatore tiene insieme la dinamicità interna e la crescita strutturale. I 'passaggi' non sono semplici variazioni amministrative, ma movimenti che modificano la posizione professionale del dipendente.",
  },
  ...
  ISG: {
    ...
    calcolo: "ISG = Personale > 60 / Personale < 40\n\nDominio: [0; +∞)",
    interpretazione:
    ...
    note: "I valori 40 e 60 potranno essere rivisti anche sulla base dei dati relativi ai valori mediani dell'età del personale.",
  },
  ...
  TEP: {
    ...
    calcolo: "TEP = Totale personale ≥ 63 / Totale Personale\n\nDominio: [0; 1]",
    interpretazione:
    ...
    note: "Il valore di 63 utilizzato come soglia dovrà essere oggetto di approfondimento. I valori di riferimento per i livelli sono indicativi.",
  },
  ...
  IQP: {
    ...
    calcolo: "IQP = Personale laureato / Totale personale\n\nDominio: [0; 1]",
    interpretazione:
  ...
  IEQ: {
    ...
    calcolo: "IEQ = (%Laureati_t − %Laureati_{t-3}) / %Laureati_{t-3}\n\nDominio: (-∞; +∞)",
    interpretazione:
  ...
  VQF: {
    ...
    calcolo: "VQF = (Donne_t / Totale_t) − (Donne_{t-1} / Totale_{t-1})",
    interpretazione:
  ...
  IFL: {
    ...
    calcolo: "IFL = Personale flessibile / Totale personale\n\nDominio: [0; 1]",
    interpretazione:
    ...
    note: "Valori elevati possono indicare maggiore adattabilità organizzativa, ma anche una possibile fragilità nella continuità operativa. L'interpretazione dei dati deve considerare le caratteristiche funzionali dell'amministrazione.",
  },
  ...
  IDLA: {
    ...
    calcolo: "IDLA = Personale in lavoro agile / Totale personale\n\nDominio: [0; 1]",
    interpretazione:
    ...
    note: "Valori elevati possono indicare maggiore adattabilità organizzativa e digitalizzazione dei processi, ma devono essere interpretati alla luce delle caratteristiche funzionali dell'amministrazione (es. presenza di attività non remotizzabili).",
  },
