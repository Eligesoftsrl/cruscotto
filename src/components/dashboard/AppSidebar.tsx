...
export const operationalSources = [
  {
    ...
    label: "Conto Annuale",
    icon: FileText,
    indicators: contoAnnualeIndicators,
  },
  {
    id: "inpa",
    label: "InPA",
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className="w-9 h-9 rounded-md flex items-center justify-center text-sm font-bold text-primary-foreground"
      ...
      {navBtn(
        ...
        <>
          <Gauge
            ...
            style={{ color: isExec ? "hsl(var(--primary))" : undefined }}
          />
            ...
            <div key={p.id}>
              ...
              >
                ...
                <PIcon
                  ...
                  style={{ color: isPillarActive ? "hsl(var(--primary))" : "hsl(210 20% 55%)" }}
                />
              ...
              {isExp && (
                ...
                >
                  {indicators.map((ind) => {
                    const isActive =
                      nav.level === "synthetic" && nav.pillar === p.id && nav.indicator === ind.id;
                    return (
                      <button
                        key={ind.id}
                        onClick={() =>
                          onNavigate({ level: "synthetic", pillar: p.id, indicator: ind.id })
                        }
          ...
          return (
            <div key={src.id}>
              ...
              >
                ...
                <SrcIcon
                  className="h-4 w-4 flex-shrink-0"
                  style={{ color: isSrcActive ? "hsl(var(--primary))" : "hsl(210 20% 55%)" }}
                />
      ...
      <div
        className="px-5 py-2.5 text-[10px] border-t flex gap-2"
        style={{ borderColor: "hsl(var(--sidebar-border))", color: "hsl(210 25% 50%)" }}
      >
        <a
          href="#"
          className="hover:underline hover:text-white/70 transition-colors focus:outline-none focus:ring-1 focus:ring-white/40 focus:rounded-sm"
        >
          Metadati
        </a>
        <span>·</span>
