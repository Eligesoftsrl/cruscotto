...
const categoryConfig = {
  ...
  plan: {
    ...
    color: "bg-[hsl(142,71%,90%)] text-[hsl(142,71%,30%)] border-[hsl(142,71%,60%)]",
  },
};
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Scegli un modello come punto di partenza e personalizzalo nel wizard di creazione
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <Badge variant="outline" className={`text-[9px] ${catCfg.color}`}>
                  {catCfg.label}
                </Badge>
                <Badge variant="secondary" className={`text-[9px] ${diffCfg.color}`}>
                  {diffCfg.label}
                </Badge>
              </div>
              ...
              <p className="text-[11px] text-muted-foreground/80 leading-snug mb-3 line-clamp-2">
                {tpl.description}
              </p>
