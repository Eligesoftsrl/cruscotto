...
export const DEFAULT_FEATURE_FLAGS: FeatureFlag[] = [
  ...
  {
    key: "scheda_formazione",
    label: "Formazione",
    description: "Scheda Conto Annuale — personale formato",
    category: "Schede Conto Annuale",
    enabled: true,
    updatedAt: "",
  },
  {
    key: "scheda_progressioni",
    label: "Progressioni",
    description: "Scheda Conto Annuale — progressioni di carriera",
    category: "Schede Conto Annuale",
    enabled: true,
    updatedAt: "",
  },
  {
    key: "scheda_analisi_personale",
    label: "Analisi del personale",
    description: "Scheda Conto Annuale — analisi del personale in servizio",
    category: "Schede Conto Annuale",
    enabled: true,
    updatedAt: "",
  },
  {
    key: "scheda_lavoro_flessibile",
    label: "Lavoro flessibile",
    description: "Scheda Conto Annuale — contratti di lavoro flessibile",
    category: "Schede Conto Annuale",
    enabled: true,
    updatedAt: "",
  },
  {
    key: "scheda_lavoro_agile",
    label: "Lavoro agile",
    description: "Scheda Conto Annuale — diffusione del lavoro agile",
    category: "Schede Conto Annuale",
    enabled: true,
    updatedAt: "",
  },
  {
    key: "scheda_analisi_genere",
    label: "Analisi per genere",
    description: "Scheda Conto Annuale — analisi per genere",
    category: "Schede Conto Annuale",
    enabled: true,
    updatedAt: "",
  },
